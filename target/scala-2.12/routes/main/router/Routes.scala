...
class Routes(
  ...
  def documentation = List(
    ...
    ("""GET""", this.prefix + (if(this.prefix.endsWith("/")) "" else "/") + """testMultiple""", """controllers.HomeController.testMultipes"""),
  ...
  // @LINE:8
  private[this] lazy val controllers_HomeController_testMultipes2_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("testMultiple")))
  )
  private[this] lazy val controllers_HomeController_testMultipes2_invoker = createInvoker(
    HomeController_0.testMultipes,
    play.api.routing.HandlerDef(this.getClass.getClassLoader,
      "router",
      "controllers.HomeController",
      "testMultipes",
  ...
  def routes: PartialFunction[RequestHeader, Handler] = {
    ...
    // @LINE:8
    case controllers_HomeController_testMultipes2_route(params@_) =>
      call { 
        controllers_HomeController_testMultipes2_invoker.call(HomeController_0.testMultipes)
      }
